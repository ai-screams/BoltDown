...
function addCopyButtons(container: HTMLElement) {
  ...
  for (const pre of pres) {
    ...
    btn.className =
      'copy-btn absolute right-2 top-2 rounded-sm bg-surface-elevated/80 px-2 py-1 text-xs text-fg-secondary opacity-0 transition-opacity hover:bg-surface-elevated group-hover:opacity-100'
